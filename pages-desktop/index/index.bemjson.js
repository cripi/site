                                ...
                                content: [
                                    ...
                                    },
                                    {
                                        ...
                                        content: [
                                            ...
                                            {
                                                tag: 'p',
                                                content: 'Занятия начнутся в октябре и будут проходить в Институте математики и компьютерных наук УрФУ (Тургенева, 4).'
                                            },
                                            {
                                                tag: 'h3',
                                    ...
                                    },
                                    {
                                        ...
                                        content:[
                                            ...
                                            {
                                                tag: 'p',
                                                content: 'Курс стартует в октябре и будут проходить в Институте математики и компьютерных наук УрФУ (Тургенева, 4).'
                                            },
                                            {
                                                tag: 'h3',
                                    ...
                                    },
                                    {
                                        ...
                                        content: [
                                            ...
                                            {
                                                tag: 'p',
                                                content: 'Занятия начнутся в конце сентября и будут проходить в офисе СКБ Контур (Радищева, 28).'
                                            },
                                            {
                                                tag: 'h3',
                                                content: 'Преподаватели'
